  ...
  initWeb3: async function() {
    ...
    if (window.ethereum) {
      ...
      try {
        ...
        await window.ethereum.enable(); //explicitly request access to the accounts
      } catch (error) {
    ...
    // If no injected web3 instance is detected, fall back to Ganache
      ...
      App.web3Provider = new Web3.providers.HttpProvider('http://localhost:7545'); //This is for development only
    }
